...
//        DID NOT IMPLEMENT: picCaptionName (field name of caption)
    ...
    var capPropName = params.capPropName;
    ...
    //add cap under the image
    var myCap = document.createElement("div");
    slideShowEle.appendChild(myCap);
    ...
    function updatePic() {
        ...
        myCap.innerHTML = obj[capPropName];
        console.log(obj[capPropName]);
    }
